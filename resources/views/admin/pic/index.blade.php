...
<div class="col-md-10">
	...
	<div class="panel panel-default">
		...
		<table class="table-bordered table table-hover" id="tables">
			...
			<tr id="tr{{$value->id}}">
				...
				<td><img width="100px" src="/Uploads/Goods/{{$value->img}}" alt=""></td>
...
<script>
	...
	function page(obj,page){
		...
		//发送ajax请求
		$.get('/admin/pic',{'page':page1},function(data){
			...
			for (var i = 0;i<data.length;i++) {
				...
				str+='<td><img width="100px" src="/Uploads/Goods/'+data[i].img+'" alt=""></td>';
