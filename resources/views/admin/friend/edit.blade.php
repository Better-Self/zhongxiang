...
<article class="page-container">
    <form class="form form-horizontal" id="form-article-add" method="post" action="/admin/friend/{{$friend->id}}">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>URL：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{$friend->url}}" placeholder="" id="url" name="url">
            </div>
        </div>
        {{method_field("PUT")}}
        {{csrf_field()}}
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">友情链接名称：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{$friend->name}}" placeholder="" id="name" name="name">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="radio-box">
                <input name="type" type="radio" id="sex-1" value="1" @if($friend->type==1)checked @endif>
                <label for="sex-1">是</label>
            </div>
            <div class="radio-box">
                <input type="radio" id="sex-2" name="type" value="0" @if($friend->type==0)checked @endif>
...
<script type="text/javascript" src="/luntan/lib/webuploader/0.1.5/webuploader.min.js"></script>
<script type="text/javascript" src="/luntan/lib/ueditor/1.4.3/ueditor.config.js"></script>
<script type="text/javascript" src="/luntan/lib/ueditor/1.4.3/ueditor.all.min.js"> </script>
<script type="text/javascript" src="/luntan/lib/ueditor/1.4.3/lang/zh-cn/zh-cn.js"></script>
