...
<article class="page-container">
    <form class="form form-horizontal" id="form-article-add" method="post" action="/admin/friend">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>URL：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{ old('url') }}" placeholder="" id="url" name="url">
            </div>
        </div>
        {{csrf_field()}}
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="radio-box">
                <input type="radio" id="sex-2" name="type" value="0">
