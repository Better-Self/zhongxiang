		...
		<div id="tab-category" class="HuiTab">
			...
			<div class="tabCon">
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">{{$forums[0]->fid}}</div>
				</div>
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="{{$forums[0]->name}}" disabled placeholder="" id="" name="name">
			...
			<input type="hidden" class="input-text" value="{{$forums[0]->type}}"  name="type">
			<input type="hidden" class="input-text" value="{{$forums[0]->fid}}"  name="fid">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9 skin-minimal">
						<div class="check-box">
							<input type="checkbox" value="1" name="status" id="checkbox-pinglun">
