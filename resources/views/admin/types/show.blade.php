...
<article class="page-container">
    <form action="" method="post" class="form form-horizontal" id="form-member-add" onsubmit="return false" >
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9"> <p class="select-box">
				<select class="select" size="1" name="fup">


                    <option value="0"><p style="class="c-green"" selected>直接添加大区</option>
...
<script type="text/javascript">
    ...
    function  add(){
        ...
        $.post('/admin/types/forum',{'str':str,'_token':'{{csrf_token()}}'},function(data){
            ...
            if(data==1){
                ...
                if(data.name){
                    ...
                    str="<div class='Huialert Huialert-info'><i class='Hui-iconfont'>&#xe6a6;</i>栏目名称输入正确</div>";
                }
